...
public class LoginEmailActivity extends AppCompatActivity {
    ...
    private void validateForm() {
        boolean isValid = Validator.isValidEmail(Objects.requireNonNull(binding.TFEmail.getEditText()).getText().toString()) &&
    ...
    private void setupButtonListeners() {
        ...
        binding.signupText.setOnSignupClickListener(() ->
                startActivity(new Intent(LoginEmailActivity.this, EnterPhoneActivity.class)
                        .putExtra("is_signup", true)));
    }

    private void attemptLogin() {
        String email = Objects.requireNonNull(binding.TFEmail.getEditText()).getText().toString();
        ...
        ShowToast.success(this, "Login attempt with email: " + email);
    }
}
